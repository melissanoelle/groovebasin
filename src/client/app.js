...
var nowPlayingDom = document.getElementById('now-playing');
var nowPlayingElapsedDom = document.getElementById('now-playing-time-elapsed');
var nowPlayingLeftDom = document.getElementById('now-playing-time-left');
var nowPlayingToggleDom = document.getElementById('now-playing-toggle');
var nowPlayingToggleIconDom = document.getElementById('now-playing-toggle-icon');
var nowPlayingPrevDom = document.getElementById('now-playing-prev');
var nowPlayingNextDom = document.getElementById('now-playing-next');
var nowPlayingStopDom = document.getElementById('now-playing-stop');
